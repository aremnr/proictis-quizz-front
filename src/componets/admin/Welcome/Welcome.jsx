...
export function Welcome() {
    ...
    return (
        <div className={styles.bg}>
            <div className={styles.OuterContainer}>
                <div className={styles.InnerContainer}>
                    ...
                    <div className={styles.buttonContainer}>
                        <div>
                            <Button variant="contained" color="secondary" onClick={handleCreateQuiz} className={styles.button}>
                                Создать квиз
                            </Button>
                        </div>
                        <Button variant="contained" color="secondary" onClick={handlePreviousQuizzes} className={styles.button}>
                            Предыдущие квиз игры
                        </Button>
                        <Button variant="contained" color="secondary" onClick={handleCreateReferralCode} className={styles.button}>
            ...
            {/* Модальное окно */}
            <Dialog open={openModal} onClose={handleCloseModal} maxWidth="lg" fullWidth PaperProps={{
        style: { borderRadius: '40px' } // Установите радиус скругления для всего окна
    }}>
                <DialogTitle style={{textAlign: 'center', 
                   
                }}>Ваш реферальный код</DialogTitle>
                                <DialogContent>
                    <div style={{
                        ...
                        <h3 style={{ fontSize: '30px', marginBottom: '56px' }}>{referralCode}</h3>
                        <p style={{ fontSize: '30px', marginTop: '8px',  fontFamily: 'ZenMaruGothic' }}>Нажмите на код для копирования!</p>
                    </div>
                </DialogContent>
